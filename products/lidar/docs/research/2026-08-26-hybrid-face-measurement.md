...
[`DOCUMENTATION_POLICY.md`](../../../../docs/DOCUMENTATION_POLICY.md), its claims are
...
3. **Polygon (ground-truth) labels**: an expert-drawn outer boundary per
   ...
   expects (see
   [`products/lidar/src/lidar_core/face_area_reference.py`](../../src/lidar_core/face_area_reference.py)
   and
   [EXP-008](../experiments/EXP-008-reference-validation-prelocalized-measurement.md)).
